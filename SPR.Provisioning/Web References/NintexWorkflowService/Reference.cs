...
namespace SPR.Provisioning.NintexWorkflowService {
    ...
    public partial class NintexWorkflowWS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback PublishWorkflow2OperationCompleted;
        ...
        private System.Threading.SendOrPostCallback EnsureWorkflowConsumptionOperationCompleted;
        ...
        public NintexWorkflowWS() {
            this.Url = global::SPR.Provisioning.Properties.Settings.Default.Provisioning_NintexWorkflowService_NintexWorkflowWS;
        ...
        /// <remarks/>
        public event PublishWorkflow2CompletedEventHandler PublishWorkflow2Completed;
        ...
        /// <remarks/>
        public event EnsureWorkflowConsumptionCompletedEventHandler EnsureWorkflowConsumptionCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://nintex.com/PublishWorkflow2", RequestNamespace="http://nintex.com", ResponseNamespace="http://nintex.com", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public WorkflowMetaData PublishWorkflow2(string wfName, string activityConfigs, System.Guid listId, string contentTypeId, string changeNotes, bool isProduction, [System.Xml.Serialization.XmlIgnoreAttribute()] bool isProductionSpecified) {
            object[] results = this.Invoke("PublishWorkflow2", new object[] {
                        wfName,
                        activityConfigs,
                        listId,
                        contentTypeId,
                        changeNotes,
                        isProduction,
                        isProductionSpecified});
            return ((WorkflowMetaData)(results[0]));
        }
        
        /// <remarks/>
        public void PublishWorkflow2Async(string wfName, string activityConfigs, System.Guid listId, string contentTypeId, string changeNotes, bool isProduction, bool isProductionSpecified) {
            this.PublishWorkflow2Async(wfName, activityConfigs, listId, contentTypeId, changeNotes, isProduction, isProductionSpecified, null);
        }
        
        /// <remarks/>
        public void PublishWorkflow2Async(string wfName, string activityConfigs, System.Guid listId, string contentTypeId, string changeNotes, bool isProduction, bool isProductionSpecified, object userState) {
            if ((this.PublishWorkflow2OperationCompleted == null)) {
                this.PublishWorkflow2OperationCompleted = new System.Threading.SendOrPostCallback(this.OnPublishWorkflow2OperationCompleted);
            }
            this.InvokeAsync("PublishWorkflow2", new object[] {
                        wfName,
                        activityConfigs,
                        listId,
                        contentTypeId,
                        changeNotes,
                        isProduction,
                        isProductionSpecified}, this.PublishWorkflow2OperationCompleted, userState);
        }
        
        private void OnPublishWorkflow2OperationCompleted(object arg) {
            if ((this.PublishWorkflow2Completed != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.PublishWorkflow2Completed(this, new PublishWorkflow2CompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://nintex.com/EnsureWorkflowConsumption", RequestNamespace="http://nintex.com", ResponseNamespace="http://nintex.com", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public void EnsureWorkflowConsumption(System.Guid workflowId, [System.Xml.Serialization.XmlIgnoreAttribute()] bool workflowIdSpecified, System.Guid listId, [System.Xml.Serialization.XmlIgnoreAttribute()] bool listIdSpecified, string workflowType) {
            this.Invoke("EnsureWorkflowConsumption", new object[] {
                        workflowId,
                        workflowIdSpecified,
                        listId,
                        listIdSpecified,
        ...
        /// <remarks/>
        public void EnsureWorkflowConsumptionAsync(System.Guid workflowId, bool workflowIdSpecified, System.Guid listId, bool listIdSpecified, string workflowType) {
            this.EnsureWorkflowConsumptionAsync(workflowId, workflowIdSpecified, listId, listIdSpecified, workflowType, null);
        }
        
        /// <remarks/>
        public void EnsureWorkflowConsumptionAsync(System.Guid workflowId, bool workflowIdSpecified, System.Guid listId, bool listIdSpecified, string workflowType, object userState) {
            if ((this.EnsureWorkflowConsumptionOperationCompleted == null)) {
                this.EnsureWorkflowConsumptionOperationCompleted = new System.Threading.SendOrPostCallback(this.OnEnsureWorkflowConsumptionOperationCompleted);
            }
            this.InvokeAsync("EnsureWorkflowConsumption", new object[] {
                        workflowId,
                        workflowIdSpecified,
                        listId,
                        listIdSpecified,
                        workflowType}, this.EnsureWorkflowConsumptionOperationCompleted, userState);
        }
        
        private void OnEnsureWorkflowConsumptionOperationCompleted(object arg) {
            if ((this.EnsureWorkflowConsumptionCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.EnsureWorkflowConsumptionCompleted(this, new System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3056.0")]
    public delegate void PublishWorkflow2CompletedEventHandler(object sender, PublishWorkflow2CompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3056.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class PublishWorkflow2CompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal PublishWorkflow2CompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3056.0")]
    public delegate void EnsureWorkflowConsumptionCompletedEventHandler(object sender, System.ComponentModel.AsyncCompletedEventArgs e);
